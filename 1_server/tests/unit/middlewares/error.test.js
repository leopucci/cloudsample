...
const ClientError = require('../../../src/utils/errors/ClientError');
...
describe('Error middlewares', () => {
  describe('Error converter', () => {
    ...
    test('should convert an Error to ClientError and preserve its status and message', () => {
    ...
    test('should convert an Error without status to ClientError with status 500', () => {
      const error = new Error('Any error');
      const next = jest.fn();
    ...
    test('should convert an Error without message to ClientError with default message of that http status', () => {
    ...
    test('should convert a Mongoose error to ClientError with status 400 and preserve its message', () => {
    ...
    test('should convert any other object to ClientError with status 500 and its message', () => {
      const error = {};
      const next = jest.fn();
  ...
  describe('Error handler', () => {
    ...
    test('should send internal server error status and message if in production mode and error is not operational', () => {
      ...
      const error = new ClientError('Any error', false);
      const res = httpMocks.createResponse();
      const sendSpy = jest.spyOn(res, 'send');
